...
## Announcement: Quip will no longer allow customers to create new Live Apps after March 5th, 2025.  This change will only impact the ability to create new Live Apps; developers will still be able to update and publish changes to existing live apps.  See [this help article](https://help.salesforce.com/s/articleView?id=004259621&type=1&language=en_US) for additional details.
