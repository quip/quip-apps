...
describe("startOfDay", () => {
    it("returns the date with the time set to 00:00:00", () => {
        expect(startOfDay(new Date(2014, 8 /* Sep */, 2, 11, 55, 0)))
            .toEqual(new Date(2014, 8 /* Sep */, 2, 0, 0, 0, 0));
    });
...
describe("endOfDay", () => {
    it("returns the date with the time set to 23:59:59.999", () => {
        expect(endOfDay(new Date(2014, 8 /* Sep */, 2, 11, 55, 0)))
            .toEqual(new Date(2014, 8 /* Sep */, 2, 23, 59, 59, 999));
    });
