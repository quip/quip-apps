...
* Work on some login command niceities: don't log in if already logged in unless --force, better error ([8f6cc44](https://github.com/quip/quip-apps/commit/8f6cc44))
